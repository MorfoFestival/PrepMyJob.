            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full h-60 p-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:outline-none transition custom-scrollbar"
                        disabled={isLoading}
                    />
                </div>
                 <div>
