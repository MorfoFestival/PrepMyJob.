        ...
        <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full max-w-5xl space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <textarea value={jobDescription} onChange={(e) => setJobDescription(e.target.value)} placeholder={t.placeholder} className="w-full h-48 md:h-60 p-4 bg-white dark:bg-gray-800 border dark:border-gray-600 border-gray-300 rounded-lg custom-scrollbar" />
