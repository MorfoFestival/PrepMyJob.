...
// FIX: Added a specific type for feature keys to ensure type safety.
...
export const Welcome: React.FC<WelcomeProps> = ({ language, onEnterApp }) => {
    const t = translations[language];
    // FIX: Changed 'welcomePage' to 'discoverPage' to match the key in constants.ts.
